...
ZG_Transitorio=function(directorio,mes,anio){
  ...
  entrada=paste0(directorio,"/",anio,"/",carpeta_anterior,"/consolidado_ISE/ZG1_Transitorios_ISE_",nombres_meses[mes-1],"_",anio,".xlsx")
  salida=paste0(directorio,"/",anio,"/",carpeta_actual,"/consolidado_ISE/ZG1_Transitorios_ISE_",nombres_meses[mes],"_",anio,".xlsx")
